 ...
 * Star class, for example.  Any object that implements this interface must provide
 * concrete definitions of each of the three method headers contained in this interface.
 * @author Alan McLeod
 * @version 1.0
 */
